package com.haoge.aigenapp.service.impl;
...
import com.haoge.aigenapp.ai.AiCodeGenTypeRoutingServiceFactory;
import com.haoge.aigenapp.ai.AiCodeGeneratorServiceFactory;
...
import com.haoge.aigenapp.core.handler.StreamHandlerExecutor;
...
import com.haoge.aigenapp.mapper.AppMapper;
import com.haoge.aigenapp.service.AppService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>  implements AppService{
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        if (codeGenTypeEnum == CodeGenTypeEnum.VUE_PROJECT) {
            ...
            ThrowUtils.throwIf(!distDir.exists(), ErrorCode.SYSTEM_ERROR, "项目构建失败");
            // 将 dist 目录作为部署源
            sourceDir = distDir;
